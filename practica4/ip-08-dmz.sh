...
#iptables -A FORWARD  -d 172.18.0.2 -i enp4s0 -p tcp --dport 80 -j ACCEPT  #**2**
#iptables -A FORWARD  -s 172.18.0.2 -o enp4s0 -p tcp --sport 80 \
#	    -m state --state ESTABLISHED,RELATED -j ACCEPT  #**2**
#iptables -A FORWARD  -d 172.18.0.3 -i enp4s0 -p tcp --dport 2013 -j ACCEPT  #**2**
#iptables -A FORWARD  -s 172.18.0.3 -o enp4s0 -p tcp --sport 2013 \
#            -m state --state ESTABLISHED,RELATED -j ACCEPT  #**2**
#iptables -A FORWARD  -d 172.19.0.2 -i enp4s0 -p tcp --dport 2080 -j ACCEPT  #**2**
#iptables -A FORWARD  -s 172.19.0.2 -o enp4s0 -p tcp --sport 2080 \
#            -m state --state ESTABLISHED,RELATED -j ACCEPT  #**2**
#iptables -A FORWARD  -d 172.19.0.3 -i enp4s0 -p tcp --dport 3013 -j ACCEPT  #**2**
#iptables -A FORWARD  -s 172.19.0.3 -o enp4s0 -p tcp --sport 3013 \
#            -m state --state ESTABLISHED,RELATED -j ACCEPT  #**2**
#
# necessari per al funcionament de l'exercici (5)
#iptables -A FORWARD  -d 172.18.0.0/16 -i enp4s0 -p tcp --dport 22 -j ACCEPT  #**3**
#iptables -A FORWARD  -s 172.18.0.0/16 -o enp4s0 -p tcp --sport 22 \
#            -m state --state ESTABLISHED,RELATED -j ACCEPT  #**3**
#iptables -A FORWARD  -d 172.19.0.0/16 -i enp4s0 -p tcp --dport 22 -j ACCEPT  #**3**
#iptables -A FORWARD  -s 172.19.0.0/16 -o enp4s0 -p tcp --sport 22 \
#            -m state --state ESTABLISHED,RELATED -j ACCEPT  #**3**
...
#iptables -A FORWARD  -s 172.18.0.0/16 -o enp4s0 -j REJECT  #**1**
#iptables -A FORWARD  -d 172.18.0.0/16 -i enp4s0 -j REJECT  #**1**

## (3) de la xarxaA només es pot accedir serveis que ofereix la 
## DMZ al servei web
#iptables -A FORWARD -s 172.18.0.0/16 -d 172.20.0.0/16 -p tcp \
#	    --dport 80 -j ACCEPT
...
## 3004->hostB2:3013
#iptables -t nat -A PREROUTING -i enp4s0 -p tcp --dport 3001 \
#	    -j DNAT --to 172.18.0.2:80
#iptables -t nat -A PREROUTING -i enp4s0 -p tcp --dport 3002 \
#            -j DNAT --to 172.18.0.3:2013
...
#iptables -t nat -A PREROUTING -i enp4s0 -p tcp --dport 3003 \
#            -j DNAT --to 172.19.0.2:2080
#iptables -t nat -A PREROUTING -i enp4s0 -p tcp --dport 3004 \
#            -j DNAT --to 172.19.0.3:3013
...
#iptables -t nat -A PREROUTING -i enp4s0 -p tcp --dport 4001 \
#            -j DNAT --to 172.18.0.2:22
#iptables -t nat -A PREROUTING -i enp4s0 -p tcp --dport 4002 \
#            -j DNAT --to 172.18.0.3:22
...
#iptables -t nat -A PREROUTING -i enp4s0 -p tcp --dport 4003 \
#            -j DNAT --to 172.19.0.2:22
#iptables -t nat -A PREROUTING -i enp4s0 -p tcp --dport 4004 \
