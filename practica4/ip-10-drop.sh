...
# Permetre tot el trafic de la pròpia ip(192.168.1.104))
...
iptables -A INPUT -s 192.168.1.44 -p tcp --sport 22 -j REJECT
iptables -A OUTPUT -d 192.168.1.44 -p tcp --dport 22 -j REJECT
iptables -A INPUT -p tcp --sport 22 -j ACCEPT
iptables -A OUTPUT -p tcp --dport 22 -j ACCEPT
#
# Accés extern al servei tftp
iptables -A INPUT -s 192.168.1.44 -p udp --dport 69 -j ACCEPT
iptables -A OUTPUT -d 192.168.1.44 -p udp --dport 69 -j ACCEPT
