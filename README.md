...
3. [EJEMPLOS](#id3)  
    ...
    3.1. [Ejemplo 01: ip-01-input.sh](#id01)  
    3.2. [Ejemplo 02: ip-02-output.sh](#id02)  
    3.3. [Ejemplo 03: ip-03-established.sh](#id03)  
    3.4. [Ejemplo 04: ip-04-icmp.sh](#id04)  
    3.5. [Ejemplo 05: ip-05-nat.sh](#id05)  
    3.6. [Ejemplo 06: ip-06-forward.sh](#id06)  
    3.7. [Ejemplo 07: ip-07-port-forwading.sh](#id07)  
    3.8. [Ejemplo 08: ip-08-dmz.sh](#id08)  
    3.9. [Ejemplo 09: ip-09-dmz2.sh](#id09)  
    3.10. [Ejemplo 10: ip-10-drop.sh](#id10)  
